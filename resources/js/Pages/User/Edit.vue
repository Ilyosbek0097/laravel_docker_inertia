...
export default defineComponent({
    ...
    setup(props) {
        ...
        const formValue = ref({
            ...
            rolesValue: props.user.roles.map(role => role.name) || [],
            password: "",
        ...
        return {
            ...
            rules: {
                ...
                password_confirmation: {
                    ...
                    validator(rule, value) {
                        if (!formRef.value.model.password) {
                            return true;
                        }

                        // Agar parol mavjud bo'lsa, tasdiqlashni tekshiradi
                        if (!value) {
            ...
            handleValidateClick(e) {
                ...
                formRef.value?.validate((errors) => {
                    if (!errors) {
                        router.put(route('user.update', { user: props.user.id}),  formRef.value.model)
                    } else {
